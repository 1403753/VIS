...
var X = {
  ...
  output: function(xy) { return point && [point[0][0], point[1][0]]; }
};
...
var Y = {
  ...
  output: function(xy) { return point && [point[0][1], point[1][1]]; }
};

var XY = {
  name: "point",
  handles: ["n", "e", "s", "w", "nw", "ne", "se", "sw"].map(type),
  input: function(xy) { return point; },
  output: function(xy) { return point; }
};
...
var tree = function() {
  ...
  // Computes all real x-context by summing up the modifiers recursively.
